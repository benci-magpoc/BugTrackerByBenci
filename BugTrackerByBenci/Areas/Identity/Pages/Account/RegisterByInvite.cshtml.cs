...
namespace BugTrackerByBenci.Areas.Identity.Pages.Account
{
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _btProjectService.AddUserToProjectAsync(userId, Input.ProjectId);
                    
                    // Add new user to role
                    await _rolesService.AddUserToRoleAsync(user, nameof(BTRoles.Submitter));
